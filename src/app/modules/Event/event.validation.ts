...
export const EventSchema = z.object({
    body:z.object({
        ...
        registrationStart: z.coerce.date({ invalid_type_error: "Invalid registration start date." }),
        registrationEnd: z.coerce.date({ invalid_type_error: "Invalid registration end date." }),
        eventStartTime: z.coerce.date({ invalid_type_error: "Invalid event start time." }),
        eventEndTime: z.coerce.date({ invalid_type_error: "Invalid event end time." }),
        seat: z
